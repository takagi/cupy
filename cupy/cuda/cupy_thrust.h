...
template <typename T> void _argsort(size_t *, void *, const std::vector<ptrdiff_t>&);
...
template <typename T> void _argsort(size_t *, void *, const std::vector<ptrdiff_t>&) { return; }
